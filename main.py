...
def compose_email(trades):
    ...
    for i, trade in enumerate(trades):
        email_body += f"Trade #{i + 1} - {str.upper(transaction_type)}\n"
        ...
        email_body += f"Ticker link: {trade['ticker_link']}\n\n"
                ...
                if filed_after:
                    ...
                    if filed_after_criteria and trade_size_criteria and trade_type_criteria:
                        ...
                        filtered_trades.append({
                            ...
                            'ticker_link' : f"https://www.tradingview.com/chart/?symbol={trade_ticker.split(':')[0]}"
                        })
